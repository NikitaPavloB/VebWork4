    ...
    <div class="w3-row-padding">
      ...
      <div class="w3-twothird">
        ...
        <div class="w3-container w3-card w3-white w3-margin-bottom">
          ...
          <?php
          // Цикл для вывода данных об опыте работы
          for ($i = 0; $i < count($workExperience); $i++) {
            echo '<div class="w3-container">';
            echo '<h5 class="w3-opacity"><b>' . $workExperience[$i]['position'] . '</b></h5>';
            echo '<h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i>' . $workExperience[$i]['date'] . '</h6>';
            echo '<p>' . $workExperience[$i]['description'] . '</p>';
            echo '<hr>';
            echo '</div>';
          }
          ?>
